...
def draw_perturbation(w, x00, y00, x01, y01, scale, a, height):
    global dirname
    ...
    x_04 = x01
    y_04 = y01
    x_05 = x00 - height/(scale*sqrt(3))
    y_05 = y00 - height/scale
    x_06 = x_02 - ((height/scale) - delta)/sqrt(3)
    y_06 = y00 - (height/scale) + delta
    x_07 = x_03 + ((height/scale) - delta) / sqrt(3)
    y_07 = y_06
    x_08 = x_04 + height/(scale * sqrt(3))
    y_08 = y_05
...
def calculate_coordinates(canvas, iteration, x00, y00, x01, y01, x02, y02, n1, n2, a, h):
    draw_perturbation(w, x00, y00, x02, y02, n1+1, side, height)
...
calculate_coordinates(w, itr+1, x00, y00, x01, y01, x02, y02, n[0]-1, n[1]-1, side, height)
